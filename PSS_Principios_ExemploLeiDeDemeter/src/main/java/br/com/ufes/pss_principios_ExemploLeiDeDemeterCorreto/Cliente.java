...
public class Cliente {
    ...
    public double pagar(double valorCobrado){
     if (this.getMinhaCarteira().getValor()>= valorCobrado) {
       this.getMinhaCarteira().subtraiValor(valorCobrado);
       return valorCobrado;
     }
     else {
       System.out.println(this.toString() + " sem dinheiro ");
       return 0;       
      }
    }
